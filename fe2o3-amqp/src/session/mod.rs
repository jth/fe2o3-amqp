...
impl endpoint::Session for Session {
    ...
    fn allocate_link(
        ...
        // Allocate link whether or not HandleMax is exceeded. 
        // The handle max will be checked by session on incoming frames
        ...
        // TODO: how to know which link to send the Flow frames 
        Ok(handle)
    }
